...
directly (no pycopper layout/font machinery involved), so a downstream
...
from pycopper.text.bidi import BidiLevels, BidiRun, l2_reorder, level_runs, resolve_levels
